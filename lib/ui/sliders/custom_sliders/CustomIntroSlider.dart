...
class IntroSliderState extends State<IntroSlider>
  ...
  void setupButtonDefaultValues() {
    ...
    if (renderSkipBtn == null) {
      renderSkipBtn = Text(
        nameSkipBtn,
        style: styleNameSkipBtn,textAlign: TextAlign.center,
      );
    }
    ...
    if (renderDoneBtn == null) {
      renderDoneBtn = SizedBox(
        ...
        child: Text(
          nameDoneBtn,
          style: styleNameDoneBtn,textAlign: TextAlign.center,
        ),
      );
    }
          ...
          children: <Widget>[
            ...
            Row(
              children: [
                InkWell(
                    onTap: onSkipPress,
                    child: Text("Skip",style: TextStyle(color: Color(0xff393533),fontSize: 20,fontWeight: FontWeight.w500),)),
                SizedBox(width: 8,),
      ...
      child: Container(
        ...
        child: ListView(
          children: <Widget>[
            ...
            Container(
             margin: marginTitle ?? EdgeInsets.only(bottom: 25),
            ...
            Container(
              ...
              margin: marginDescription ?? EdgeInsets.fromLTRB(20.0, 7.0, 20.0, 50.0),
            ),
          ],
        ),
      ),
